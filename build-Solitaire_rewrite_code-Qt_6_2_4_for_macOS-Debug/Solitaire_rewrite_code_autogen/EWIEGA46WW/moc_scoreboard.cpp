...
#include <memory>
#include "../../../Solitaire_rewrite_code/scoreboard.h"
...
QT_MOC_LITERAL(11, 16), // "close_scoreboard"
QT_MOC_LITERAL(28, 0) // ""

    },
    "Scoreboard\0close_scoreboard\0"
};
...
void Scoreboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->close_scoreboard(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Scoreboard::close_scoreboard)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Scoreboard, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void Scoreboard::close_scoreboard()
{
