...
#include <memory>
#include "../../../Solitaire_rewrite_code/table.h"
...
void Table::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Table::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Table::close_table)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Table, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
